...
out = cv.VideoWriter('res3.avi', fourcc, 20.0, (640,480))
...
while(cap.isOpened()):
    ...
    # 判断正向还是逆向
    top = contour_max[contour_max[:, :, 1].argmin()][0]  # 最上点
    bottom = contour_max[contour_max[:, :, 1].argmax()][0]  # 最下点
    # print(f'上{top}')
    # print(f'下{bottom}')
    # print(f'重心{place}')
    top_y = int(top[1])
